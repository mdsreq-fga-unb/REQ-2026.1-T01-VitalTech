...
>>>>>>> 70f9808 (fix(docs): preserva conteúdo original de planning da sprint 2 feito pelo Enzo e adiciona V/V)
...
<video width="100%" controls>
  <source src="../../../assets/videos/sprint2_planning.mp4" type="video/mp4">
...
| 14/06/2026 | 1.2 | Registro da ata de Planning da Sprint 2 com atividades de V/V e adição de Gravação | Alberto Côrtes |
