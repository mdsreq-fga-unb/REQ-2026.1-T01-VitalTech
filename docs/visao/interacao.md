...
| Sprint 4 | Software funcional e validação de produto | US04, US05, US14, US11, US02, US06 e US15. | Marcelo Souza, por formulário de validação; equipe e PO por revisão técnica. | O produto foi validado por formulário externo do cliente. A equipe manteve a separação entre validação do produto e status técnico de cada User Story. | **Validado pelo cliente, com status técnico por US.** | US04, US05, US14, US11, US02, US06 e US15 registradas como concluídas no recorte entregue; para US04 e US05, o MVP cobriu registro e consulta via histórico, mantendo edição como evolução posterior. | [Review Sprint 4](../sprints/sprint4/review.md), [formulário de validação do cliente](https://docs.google.com/forms/d/1jZYJ1vcGutQ4t1C4xJf9qxUmTCGUxZ5RH_nczJL-CFs/edit?ts=6a301b5f#responses), [Matriz de Priorização](priorizacao.md#101-mvp-implementado-e-evidenciado-por-user-story) e PRs da Sprint 4. |
