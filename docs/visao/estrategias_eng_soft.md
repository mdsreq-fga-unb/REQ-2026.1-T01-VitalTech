...
| **Desenvolvimento iterativo e incremental** | Organização das entregas por User Stories e construção progressiva de fluxos funcionais ao longo das sprints. | [Story Map](story_map.md), [Planejamento e Evidências](../planejamento_organizacao/planejamento_e_evidencias.md) e [integração funcional da Sprint 2](https://github.com/mdsreq-fga-unb/REQ-2026.1-T01-VitalTech/pull/43). |
