...
A tabela abaixo explicita o status de implementação do MVP por User Story, relacionando cada entrega com sprint, evidência disponível, PR, testes e validação. A leitura separa histórias concluídas, parciais e pendentes para evitar tratar como finalizado aquilo que ainda não possui evidência suficiente.

| User Story | Sprint planejada / execução | Status | Evidência visual ou processual | PR | Teste | Validação | Registro |
| --- | --- | :---: | --- | --- | --- | --- | --- |
...
| [**US04**](user_stories.md#us04) | Sprint 3, realocada para Sprint 4 | **Parcial** | [Review Sprint 3](../sprints/sprint3/review.md) registra débito técnico; [Planning Sprint 4](../sprints/sprint4/planning.md) registra replanejamento. | [PR #83](https://github.com/mdsreq-fga-unb/REQ-2026.1-T01-VitalTech/pull/83) e [PR #85](https://github.com/mdsreq-fga-unb/REQ-2026.1-T01-VitalTech/pull/85). | 30 testes aprovados e build concluído. | Validação técnica por PR e testes. | Registro e persistência foram evidenciados; edição/consulta completa permanecem rastreadas nos critérios da US composta. |
| [**US05**](user_stories.md#us05) | Sprint 3, realocada para Sprint 4 | **Parcial** | [Review Sprint 3](../sprints/sprint3/review.md) registra débito técnico; [Planning Sprint 4](../sprints/sprint4/planning.md) registra replanejamento. | [PR #83](https://github.com/mdsreq-fga-unb/REQ-2026.1-T01-VitalTech/pull/83), [PR #84](https://github.com/mdsreq-fga-unb/REQ-2026.1-T01-VitalTech/pull/84) e [PR #85](https://github.com/mdsreq-fga-unb/REQ-2026.1-T01-VitalTech/pull/85). | PR #83 registra 30 testes; PR #84 possui roteiro de validação manual. | Validação técnica por PR e testes. | Registro de rotinas foi evidenciado; edição/consulta completa permanecem rastreadas nos critérios da US composta. |
| [**US14**](user_stories.md#us14) | Sprint 3, realocada para Sprint 4 | **Concluída** | [Review Sprint 3](../sprints/sprint3/review.md), [Planning Sprint 4](../sprints/sprint4/planning.md) e componente `HistoricoAssistencial.vue`. | [PR #83](https://github.com/mdsreq-fga-unb/REQ-2026.1-T01-VitalTech/pull/83) e [PR #85](https://github.com/mdsreq-fga-unb/REQ-2026.1-T01-VitalTech/pull/85). | Testes do `assistenciaService` cobrem listagem do histórico por residente. | Validação técnica por PR e testes. | O PR dedicado à US14 (#82) foi fechado, e a entrega foi absorvida por PRs integrados da Sprint 4. |
| [**US11**](user_stories.md#us11) | Sprint 4 | **Concluída** | PRs de Sprint 4 com checklist e validação. | [PR #90](https://github.com/mdsreq-fga-unb/REQ-2026.1-T01-VitalTech/pull/90) e [PR #93](https://github.com/mdsreq-fga-unb/REQ-2026.1-T01-VitalTech/pull/93). | PR #90 registra 35 testes aprovados e build concluído. | Revisão por PR. | Atualização de usuário com validação, permissão e rastreabilidade. |
| [**US02**](user_stories.md#us02) | Sprint 4 | **Concluída** | PRs de Sprint 4 com checklist e validação. | [PR #90](https://github.com/mdsreq-fga-unb/REQ-2026.1-T01-VitalTech/pull/90) e [PR #93](https://github.com/mdsreq-fga-unb/REQ-2026.1-T01-VitalTech/pull/93). | PR #90 registra 35 testes aprovados e build concluído. | Revisão por PR. | Edição de residente preserva vínculos e valida CPF duplicado. |
| [**US06**](user_stories.md#us06) | Sprint 4 | **Concluída** | PR de medicamentos com checklist de teste e validação local. | [PR #91](https://github.com/mdsreq-fga-unb/REQ-2026.1-T01-VitalTech/pull/91). | PR #91 registra testes unitários, build e validação local. | Revisão por PR. | Registro de administração e não administração de medicamentos integrado ao histórico. |
| [**US15**](user_stories.md#us15) | Sprint 4 | **Concluída** | PR de Sprint 4 com descrição de testes e build. | [PR #92](https://github.com/mdsreq-fga-unb/REQ-2026.1-T01-VitalTech/pull/92). | PR #92 registra 32 testes e build concluído. | Validação técnica da equipe. | Filtro por período considerado integrado pela equipe no fechamento da Sprint 4. |
| [**US12**](user_stories.md#us12) | Sprint 5 | **Pendente** | [Planning Sprint 5](../sprints/sprint5/planning.md). | Não há PR integrado. | Não há testes registrados. | Não validada. | Planejada, sem evidência de implementação no estado atual. |
| [**US13**](user_stories.md#us13) | Sprint 5 | **Pendente** | [Planning Sprint 5](../sprints/sprint5/planning.md). | Não há PR integrado. | Não há testes registrados. | Não validada. | Planejada, sem evidência de implementação no estado atual. |
| [**US07**](user_stories.md#us07) | Sprint 5 | **Pendente** | [Planning Sprint 5](../sprints/sprint5/planning.md). | Não há PR integrado. | Não há testes registrados. | Não validada. | Planejada, sem evidência de implementação no estado atual. |
| [**US16**](user_stories.md#us16) | Sprint 5 | **Pendente** | [Planning Sprint 5](../sprints/sprint5/planning.md). | Não há PR integrado. | Não há testes registrados. | Não validada. | Realocada para a Sprint 5, sem evidência de implementação no estado atual. |
