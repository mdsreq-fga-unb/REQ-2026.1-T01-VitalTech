...
| Sprint 5 | **US12** | [Planning Sprint 5](../sprints/sprint5/planning.md) | Atendido | Atendido | Atendido | Atendido | Atendido | **Atendido** | Redefinição de senha possuía persona, critérios de aceite, permissão por perfil e testes planejados. |
| Sprint 5 | **US13** | [Planning Sprint 5](../sprints/sprint5/planning.md) | Atendido | Atendido | Atendido | Atendido | Atendido | **Atendido** | Revogação de acesso possuía regra clara de bloqueio de sessão e preservação de registros históricos. |
| Sprint 5 | **US03** | [Planning Sprint 5](../sprints/sprint5/planning.md) | Atendido | Atendido | Atendido | Atendido | Atendido | **Atendido** | Inativação de residente possuía regra de preservação de histórico e escopo verificável. |
| Sprint 5 | **US07** | [Planning Sprint 5](../sprints/sprint5/planning.md) | Atendido | Atendido | Atendido | Parcial | Atendido | **Atendido com dependência registrada** | Ocorrências clínicas dependiam da estrutura assistencial existente; a dependência foi registrada e tratada no planejamento. |
| Sprint 5 | **US16** | [Planning Sprint 5](../sprints/sprint5/planning.md) | Atendido | Atendido | Atendido | Parcial | Atendido | **Atendido com dependência registrada** | Resumo assistencial dependia dos registros já existentes; estados vazios por módulo foram planejados. |
...
| **US04** | **Concluída no recorte MVP** | Registro, persistência, validação e consulta via histórico de sinais vitais. | [Planning Sprint 4](../sprints/sprint4/planning.md), [Review Sprint 4](../sprints/sprint4/review.md) e PRs de Sprint 4. | [PR #83](https://github.com/mdsreq-fga-unb/REQ-2026.1-T01-VitalTech/pull/83) e [PR #85](https://github.com/mdsreq-fga-unb/REQ-2026.1-T01-VitalTech/pull/85). | PR #83 registra 30 testes aprovados e build concluído. | O MVP cobriu registro e consulta; a edição de registros assistenciais permanece como evolução posterior sem renumerar a US original. |
| **US05** | **Concluída no recorte MVP** | Registro, persistência, validação e consulta via histórico de rotinas assistenciais. | [Planning Sprint 4](../sprints/sprint4/planning.md) e [Review Sprint 4](../sprints/sprint4/review.md). | [PR #83](https://github.com/mdsreq-fga-unb/REQ-2026.1-T01-VitalTech/pull/83), [PR #84](https://github.com/mdsreq-fga-unb/REQ-2026.1-T01-VitalTech/pull/84) e [PR #85](https://github.com/mdsreq-fga-unb/REQ-2026.1-T01-VitalTech/pull/85). | PR #83 registra 30 testes aprovados; PR #84 contém roteiro de validação manual. | O MVP cobriu registro e consulta; a edição de registros assistenciais permanece como evolução posterior sem renumerar a US original. |
...
| **US12** | **Done** | Redefinição de senha, invalidação da credencial anterior e bloqueio para perfil sem permissão. | [Review Sprint 5](../sprints/sprint5/review.md). | [PR #110](https://github.com/mdsreq-fga-unb/REQ-2026.1-T01-VitalTech/pull/110). | Teste automatizado em `services.test.js` na linha 1167; suíte local com 51 testes aprovados. | Entrega concluída e verificada tecnicamente. |
| **US13** | **Done** | Revogação de acesso, bloqueio de nova sessão e preservação dos registros históricos. | [Review Sprint 5](../sprints/sprint5/review.md). | [PR #110](https://github.com/mdsreq-fga-unb/REQ-2026.1-T01-VitalTech/pull/110). | Teste automatizado em `services.test.js` na linha 1198; suíte local com 51 testes aprovados. | Entrega concluída e verificada tecnicamente. |
| **US03** | **Done** | Inativação lógica de residente, remoção da lista operacional e preservação do histórico assistencial. | [Review Sprint 5](../sprints/sprint5/review.md). | [PR #110](https://github.com/mdsreq-fga-unb/REQ-2026.1-T01-VitalTech/pull/110). | Teste automatizado em `services.test.js` na linha 1235; suíte local com 51 testes aprovados. | Entrega concluída como incremento adicional fora do recorte formal do MVP. |
| **US07** | **Done** | Registro, consulta e edição de ocorrência clínica, rastreabilidade e sinalização de notificação. | [Review Sprint 5](../sprints/sprint5/review.md). | [PR #110](https://github.com/mdsreq-fga-unb/REQ-2026.1-T01-VitalTech/pull/110). | Teste automatizado em `services.test.js` na linha 1265; suíte local com 51 testes aprovados. | Entrega concluída e verificada tecnicamente. |
| **US16** | **Done** | Resumo assistencial com último registro por módulo e estados vazios explícitos. | [Review Sprint 5](../sprints/sprint5/review.md). | [PR #110](https://github.com/mdsreq-fga-unb/REQ-2026.1-T01-VitalTech/pull/110). | Teste automatizado em `services.test.js` na linha 1355; suíte local com 51 testes aprovados. | Entrega concluída e verificada tecnicamente. |
